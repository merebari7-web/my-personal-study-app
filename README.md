...
**19 subjects of SS1–SS3 lesson notes** · 3,900 verified questions with full explanations · JAMB/UTME simulation with on-screen calculator · essay/theory practice · games + a video studio · tiny files (index.html + bank.js + on-demand labs.js / edu.js / arcade.js) — no install, no internet, no dependencies.
