...
| 📚 Mater Notes library | **v21.0** — the **Mater Misericordiae Secondary School (Rumomasi) weekly lesson notes** are now part of the site: **30 real lesson-note PDFs** — SS1, SS2 and SS3 × 10 subjects × weeks 1–6 of First Term 2026/2027 (SS1 & SS3 authored to the school's week-by-week syllabus, SS2 as supplied) — all reachable in-app via a new **📚 Mater Notes** launcher. The library opens as a gold-accented overlay with SS1/SS2/SS3 tabs and subject cards showing the week's topics and an **Open PDF** button for each note (downloads or opens in a new tab; the notes live in `mater-notes/`, so they print cleanly). The whole module ships as a lazy, service-worker-cached sibling (`quiz/mater_data.js`, ≈16 KB) — boot stays under the gate. Verified: v21 suite 10/10 (30-entry data check, every PDF present & valid, real-Chrome 375px + 1280px open/no-overflow), all v14–v20 suites green, 8-viewport probe + 12-viewport audit 0 issues, bank untouched, boot wire 264.7 KiB ≤ 266,240 B gate, SW cache key `-v21` |
