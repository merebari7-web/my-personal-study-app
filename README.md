...
| ✨ Aurum polish layer | **v24.0** — a graphics & UI upgrade layered over the existing theme: **animated gold-shimmer headline** (gradient sweep across the hero title), a **twinkling gold particle field + breathing halo** in the hero, **glass stat plates** with inner gold frames and a rise-in animation, **gold-edged card hovers**, **shine-swept AI Coach buttons**, a gold gradient scrollbar, lifted primary buttons and a glowing graduation flour. Everything ships in a **lazy, boot-safe module** (`quiz/polish.js`, ~3 KB) loaded after the app — boot wire stays at 264,498 B ≤ 266,240 B, `bank.js` untouched, `prefers-reduced-motion` respected. Verified: v24 suite 12/12 (real-Chrome 375/1280/1920: polish applied, zero page errors, zero overflow), v20 + v23 regressions green, 12-viewport audit **0 issues**, SW cache key `-v24`. |
