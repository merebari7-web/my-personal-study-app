...
- `quiz/holo.js` (v33) — Holo 3D Lab: molecule viewer, 3D surface plotter, orbital solar system (canvas-2D projection, orbit/zoom/auto-rotate, reduced-motion aware); idle-loaded by `polish.js`; palette entries via `__proPalHooks`.
