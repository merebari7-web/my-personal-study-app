/* v29.0 suite — Pro Boost (merged over Apex HQ v28) (lazy quiz/boost.js, loaded by polish.js at idle):
   ...
   plus two new command-palette entries. SW key -v29.
   Run: node quiz/_test_v29.js */
const fs = require("fs");
